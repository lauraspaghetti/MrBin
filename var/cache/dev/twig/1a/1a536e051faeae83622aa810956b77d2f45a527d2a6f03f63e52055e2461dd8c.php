...
/* home/main.html.twig */
class __TwigTemplate_01510017fdaf08ac42e5796e14d321a5e72c3560386ce6733625375422ce4fa1 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 8
        echo "        <h2>Nos ";
        echo twig_escape_filter($this->env, twig_length_filter($this->env, (isset($context["articles"]) || array_key_exists("articles", $context) ? $context["articles"] : (function () { throw new RuntimeError('Variable "articles" does not exist.', 8, $this->source); })())), "html", null, true);
        echo " derniers articles :</h2>";
        // line 9
        echo "            ";
...
";
    ...
    {
        return array (  111 => 14,  102 => 11,  99 => 10,  94 => 9,  90 => 8,  80 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% block content %}
        <h2>Nos {{ articles | length }} derniers articles :</h2>{#afficher la longueur du tableau dans la balise twig#}
            {% for article in articles %}{#boucle pour afficher les articles dans ce template#}
                 <p>
                    {{article}} 
                 </p>
            {% endfor %}
...
", "home/main.html.twig", "/Users/moussaillon/Documents/Symfony/MrBin/templates/home/main.html.twig");
    }
}
